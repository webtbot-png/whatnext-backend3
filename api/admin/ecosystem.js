...
// NOTE: POST /spend route removed to prevent conflicts with dedicated /api/admin/ecosystem/spend router
// DELETE routes are handled by the dedicated spend router
