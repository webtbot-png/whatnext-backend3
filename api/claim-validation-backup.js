...
const pumpfunRouter = require('./pumpfun/index.js');
const pumpfunStatsRouter = require('./pumpfun/stats.js');
const pumpfunDataRouter = require('./pumpfun/data.js');
const pumpfunTokenDataRouter = require('./pumpfun/token-data.js');
const metadataRouter = require('./metadata.js');
const qrCodesRouter = require('./qr-codes.js');
const giveawayRouter = require('./giveaway.js');
const giveawayWinnersRouter = require('./giveaway/winners.js');
const ecosystemRouter = require('./ecosystem/index.js');
